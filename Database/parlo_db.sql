...
--
-- Host: localhost:3306
-- Waktu pembuatan: 20 Okt 2019 pada 15.55
-- Versi server: 5.7.24
-- Versi PHP: 7.2.19
...
--
-- Struktur dari tabel `boxes_section`
--
...
--
-- Dumping data untuk tabel `boxes_section`
--
...
--
-- Indeks untuk tabel `boxes_section`
--
...
--
-- AUTO_INCREMENT untuk tabel `boxes_section`
--
ALTER TABLE `boxes_section`
